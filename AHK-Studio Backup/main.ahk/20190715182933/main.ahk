...
{
	game = 0
	Gui, Add, Picture, x-8 y-1 w280 h460 , %A_ScriptDir%\resources\menu.png
	Gui, Add, Picture, x52 y49 w160 h80  , %A_ScriptDir%\resources\csgo0.jpg
	Gui, Add, Picture, x22 y139 w230 h90 , %A_ScriptDir%\resources\HW0.jpg
	Gui, Add, Picture, x72 y239 w120 h70 , %A_ScriptDir%\resources\samp0.jpg
