...
tray_Handler:
{
	IniRead,tray_name1, settings.ini,name1
	IniRead,tray_name2, settings.ini,name2
	IniRead,tray_name3, settings.ini,name3
	IniRead,tray_name4, settings.ini,name4
	IniRead,tray_name5, settings.ini,name5
	IniRead,tray_name6, settings.ini,name6
	IniRead,tray_name7, settings.ini,name7
	IniRead,tray_name8, settings.ini,name8
	IniRead,tray_name9, settings.ini,name9
	IniRead,tray_name10, settings.ini,name10
	IniRead,tray_path1,settings.ini,path1
	IniRead,tray_path2,settings.ini,path2
	IniRead,tray_path3,settings.ini,path3
	IniRead,tray_path4,settings.ini,path4
	IniRead,tray_path5,settings.ini,path5
	IniRead,tray_path6,settings.ini,path6
	IniRead,tray_path7,settings.ini,path7
	IniRead,tray_path8,settings.ini,path8
	IniRead,tray_path9,settings.ini,path9
	IniRead,tray_path10,settings.ini,path10
