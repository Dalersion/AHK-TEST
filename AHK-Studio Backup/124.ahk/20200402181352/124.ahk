...
tray_Handler:
{
	...
	ElseIf ( A_ThisMenuItem = %tray_name2% )
	{
		Run, %tray_path2%
	}
	
	ElseIf ( A_ThisMenuItem = %tray_name3% )
	{
		Run, %tray_path3%
	}
	
	ElseIf ( A_ThisMenuItem = %tray_name4% )
	{
		Run, %tray_path4%
	}
	
	ElseIf ( A_ThisMenuItem = %tray_name5% )
	{
		Run, %tray_path5%
	}
	
	ElseIf ( A_ThisMenuItem = %tray_name6% )
	{
		Run, %tray_path6%
	}
	
	ElseIf ( A_ThisMenuItem = %tray_name7% )
	{
		Run, %tray_path7%
	}
	
	ElseIf ( A_ThisMenuItem = %tray_name8% )
	{
		Run, %tray_path8%
	}
	
	ElseIf ( A_ThisMenuItem = %tray_name9% )
	{
		Run, %tray_path9%
	}
	
	ElseIf ( A_ThisMenuItem = %tray_name10% )
	{
		Run, %tray_path10%
	}
