...
tray_Handler:
{
	...
	IniRead,tray_path1,settings.ini,path1, 2
	IniRead,tray_path2,settings.ini,path2, 2
	IniRead,tray_path3,settings.ini,path3, 2
	IniRead,tray_path4,settings.ini,path4, 2
	IniRead,tray_path5,settings.ini,path5, 2
	IniRead,tray_path6,settings.ini,path6, 2
	IniRead,tray_path7,settings.ini,path7, 2
	IniRead,tray_path8,settings.ini,path8, 2
	IniRead,tray_path9,settings.ini,path9, 2
	IniRead,tray_path10,settings.ini,path10, 2
