...
porner(ByRef request, ByRef response) 
{
	...
	response.SetBodytext("%Vname1%</pre><video src="porne?numb=%numb%" width="480" height="270" controls=""></video><pre style="word-wrap: break-word; white-space: pre-wrap;">%Vname%")
