...
{
	FileDelete, redir.htmlr
	IfWinNotExist, file server
	{
		run, file server.ahk
	}
	Sleep, 200
	numb:= request.queries["Number"] 
	if(numb = "")
	{
	...
	<body>
		<a href="http://localhost:8080/porne?numb=%numb%" ><span style="color: #f61212;">redir</span></a>
	</body>
</html>
		)
