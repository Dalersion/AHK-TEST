IniRead,old_instance, %A_AppData%/Dalersion/ShortCuter/settings.ini,2,old_instance
if(A_IsCompiled = 1)
{
	gui_c = 0
	IfNotExist, %A_AppData%/Dalersion/ShortCuter/settings.ini
	{
	...
	IfNotExist,%A_Startup%/ShortCuter.exe
	{
		...
		IniWrite,%A_ScriptFullPath%,%A_AppData%/Dalersion/ShortCuter/settings.ini,2,old_instance
		Process, Exist, %PID%
		if(ErrorLevel !=0)
		{
			;IniWrite,%A_ScriptFullPath%,%A_AppData%/Dalersion/ShortCuter/settings.ini,2,old_instance 
	...
	script_path1 = %A_Startup%/ShortCuter.exe
	script_path2 = %A_ScriptFullPath%
	IfExist, script_path1
	{
		if( script_path1 = script_path2)
		{
			FileDelete, %old_instance%
			IniWrite, %ErrorLevel%, %A_AppData%/settings.ini,2,ErrorLevel
			IniDelete, %A_AppData%/Dalersion/ShortCuter/settings.ini,2,old_instance
		}
		Else
		{
			4:
			Run, %A_Startup%/ShortCuter.exe,,,PID2
			IniWrite,%A_ScriptFullPath%,%A_AppData%/Dalersion/ShortCuter/settings.ini,2,old_instance
			Process, Exist, %PID2%
			if(ErrorLevel !=0)
			{
	...
	Button1:
	{
		...
		if (check = 0)
		{
			if(edit1 != edit2)
			{
				...
				IniWrite, %edit1%,%A_AppData%/Dalersion/ShortCuter/settings.ini,1,name%ini_numb%
				IniWrite, %edit2%,%A_AppData%/Dalersion/ShortCuter/settings.ini,1,path%ini_numb%
				IniWrite, %ini_numb%, %A_AppData%/Dalersion/ShortCuter/settings.ini,1,numb
				Reload
				return
			}
		}
