...
if(A_IsCompiled = 1)
{
	...
	/*^+1::
	{
		goto, TrayMenuNimber1
		return
	}
	^+2::
	{
		goto, TrayMenuNimber2
		return
	}
	^+3::
	{
		goto, TrayMenuNimber3
		return
	}
	^+4::
	{
		goto, TrayMenuNimber4
		return
	}
	^+5::
	{
		goto, TrayMenuNimber5
		return
	}
	^+6::
	{
		goto, TrayMenuNimber6
		return
	}
	^+7::
	{
		goto, TrayMenuNimber7
		return
	}
	^+8::
	{
		goto, TrayMenuNimber8
		return
	}
	^+9::
	{
		goto, TrayMenuNimber9
		return
	}
	^+0::
	{
		goto, TrayMenuNimber0
		return
	}
	*/
