...
Screen(ByRef req, ByRef res,ByRef server)
{
	...
	Send, {PRINTSCREEN}
	path := A_AppData . "\Dalersion\temp\tempscreen.png"
	FileDelete, %path%
	FileAppend,, %path%
	Run, mspaint %path%,, Hide
	WinWait, tempscreen.png - Paint
	PostMessage, 0x111, 57637, 0, , tempscreen.png - Paint
	PostMessage, 0x111, 57603, 0, , tempscreen.png - Paint
	PostMessage, 0x111, 57665, 0, , tempscreen.png - Paint
	WinWaitClose, tempscreen.png - Paint
